...
function ccEvent(channel, number, value)
{
	...
	if (lookupData) {
		...
		var ga = myKitParam.get();
		script.log("phaserChecksum="+phaserChecksum+" ga="+ga);
		if (channel == 11 && number == 125 && value == 0) {
			...
			var sbfChecksum = (128 - ((ga + 165) % 128)) % 128;
			script.log("SWITCH to flanger");
			local.sendSysex(0xF0,0x41,0x10,0x00,0x00,0x00,0x6D,0x12,0x10,ga,0x03,0x00,0x07,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0A,0x00,0x0B,0x08,0x08,0x0E,0x0E,0x08,0x03,0x0C,0x00,0x0A,0x00,0x01,0x00,0x01,0x0D,0x06,0x0D,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,sbfChecksum,0xF7);
		}
